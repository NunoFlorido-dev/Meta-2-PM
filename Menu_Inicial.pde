class MenuIn extends MenuVis2 {
  ...
  MenuIn(color c1, color c2) {
    ...
    back = color(c1);
    Botao = new Botao[2];
    //Botão 0: Botao de start, Botao 1: botão de load Music
    Botao[0] = new Botao(cordsBotaoPlay, color(c1), color(255), ">",
      70, 250);
    Botao[1] = new Botao(cordsBotaoLoadMusic, color(c1), color(255),
